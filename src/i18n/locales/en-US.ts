...
export const enUS: I18N = {
  ...
  'settings.readingPreset': 'Reading Layout',
  'settings.readingPreset.focused': 'Focused',
  'settings.readingPreset.focused.desc': 'Narrow long-form reading',
  'settings.readingPreset.comfortable': 'Comfortable',
  'settings.readingPreset.comfortable.desc': 'Balanced everyday layout',
  'settings.readingPreset.wide': 'Wide',
  'settings.readingPreset.wide.desc': 'More room for tables and code',
  ...
  'settings.reopenLastSession': 'Reopen files from the previous session',
  ...
  'key.switchTab': 'Switch to the previous / next tab',
  ...
  'status.sessionRestored': 'Restored {count} file(s) from your previous session',
