...
export const zhCN: I18N = {
  ...
  'settings.readingPreset': '阅读版式',
  'settings.readingPreset.focused': '窄幅',
  'settings.readingPreset.focused.desc': '长文专注阅读',
  'settings.readingPreset.comfortable': '舒适',
  'settings.readingPreset.comfortable.desc': '日常阅读默认',
  'settings.readingPreset.wide': '宽屏',
  'settings.readingPreset.wide.desc': '表格与代码更宽',
  ...
  'settings.reopenLastSession': '启动时重新打开上次文件',
  ...
  'status.sessionRestored': '已恢复上次打开的 {count} 个文件',
